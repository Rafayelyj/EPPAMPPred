...
model_save_path = "../Progen2/models"
...
positive_file_path = "../Progen2/feature/XU_pretrain_train_positive_features_z_score_normalized.csv"
negative_file_path = "../Progen2/feature/XU_pretrain_train_negative_features_z_score_normalized.csv"
positive_test_file_path = "../Progen2/feature/XU_AMP_features_z_score_normalized.csv"
negative_test_file_path = "../Progen2/feature/XU_nonAMP_features_z_score_normalized.csv"
...
test_features_preprocessed = test_features_preprocessed.reshape(test_features_preprocessed.shape[0], 1, test_features_preprocessed.shape[1])
...
for fold, (train_index, val_index) in enumerate(skf.split(features_preprocessed, labels)):
    ...
    if val_sn > best_sn:
        ...
        model_save_name = os.path.join(model_save_path, f"best_LSTMmodel_fold_{fold + 1}_sn_{val_sn:.4f}.h5")
